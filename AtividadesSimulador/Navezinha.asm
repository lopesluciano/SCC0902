...
RecalculaPos:
	inc r0   		;aumenta o valor da posicao do caractere
	loadn r3, #1200 ;carrega no registrador 3 o valor a ser comparado com o valor posicao em r0
	cmp r0, r3		;comparacao
	jne RecalculaPos_Nao_Final
	loadn r0, #40   ;se r0 maior ou igual a que r3, reseta o valor da posicao 
RecalculaPos_Nao_Final:
	rts	
	
ImprimeObj:
	outchar r1, r0	; r0->Pos   r1->"O"
	rts	
